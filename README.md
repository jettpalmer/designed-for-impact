...
The root `.nojekyll` file is copied into `docs/` during rendering so GitHub Pages serves Quarto's static output without attempting a Jekyll build. The published URL is `https://jettpalmer.github.io/designed-for-impact/`.
